  ...
  <div className="container">
      ...
      <div className="col-12 text-center">
        <div className="heading">
          ...
          <p >
            ...
            Lorem Ipsum has been the industry <br/> standard dummy text ever since an
    ...
    <div className="row">
      {[
        ...
        { title: "Data Science & Analytics", jobs: 155, icon: "fa-chart-pie" },
        { title: "Accounting & Consulting", jobs: 300, icon: "fa-briefcase" },
        { title: "Writing & Translations", jobs: 80, icon: "fa-pen-ruler" },
        ...
        { title: "Education & Training", jobs: 210, icon: "fa-chalkboard-teacher" },
      ].map((category, index) => (
